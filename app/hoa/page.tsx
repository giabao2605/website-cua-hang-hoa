    ...
    <>
      <section className="seasonal-page-hero">
        <div className="container seasonal-hero-layout">
          ...
          <figure className="seasonal-hero-visual"><Image src="/editorial/chon-hoa-theo-mua.webp" alt="Những cành tulip xanh được chọn tại chợ hoa" fill priority sizes="(max-width: 760px) 100vw, 48vw" /><figcaption><span>Ghi chú mùa hoa</span><strong>Chọn cành đẹp trước, kết hoa sau</strong></figcaption></figure>
        </div>
      </section>
